...
import 'package:align_ai/widgets/search_bar.dart' as CustomSearchBar;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 10),
            CustomSearchBar.SearchBar('What do you want to do today? Cardio?'), // Instantiate the CustomSearchBar with the positional argument
            SizedBox(height: 10),
            SizedBox(
              //width: screen.width,
              height: 350,
