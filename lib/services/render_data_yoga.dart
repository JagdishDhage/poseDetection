...
class _RenderDataYogaState extends State<RenderDataYoga> {
  ...
  String exercise = 'warrior';
  Color correctColor = Colors.black;
  Color armColor = Colors.black;
  Color shoulderColor = Colors.black;
  Color legColor = Colors.black;
  String memo = 'Warrior position not aligned.';

  double leftShoulderY = 0;
  ...
  double leftAnkleX = 0;
  double rightAnkleX = 0;
  double leftKneeY = 0;
  double leftHipY = 0;

  bool wristAlignment = false;
  bool shoulderAlignment = false;
  bool ankleAlignment = false;
  bool kneeAndHipAlignment = false;
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    setState(() {
      ...
      rightWristY = poses['rightWrist']![1];
